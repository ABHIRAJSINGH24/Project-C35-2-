class Basket3{
    constructor(x,y,width,height,color){
        ...
        this.body2 = Bodies.rectangle(this.x-this.width/2,this.y+this.height/2+25,this.width-50,this.height+50,options);
        World.add(world,this.body2);
        this.body3 = Bodies.rectangle(this.x+this.width/2,this.y+this.height/2+25,this.width-50,this.height+50,options);
